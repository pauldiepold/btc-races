                ...
                <form @submit.prevent="submitRegistration">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Falls du deinen Namen nicht in der Liste findest,
                            kontaktiere bitte den Vorstand.
                        </p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Die E-Mail-Adresse wird automatisch aus deinem
                            Mitgliedsprofil übernommen.
                        </p>
                    </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                ...
                                >
                                    Ich bestätige hiermit meine Teilnahme am
                                    Wettkampf *
                                </label>
                                <p class="text-gray-500">
                                    Nach Absenden des Formulars erhältst du eine
                                    Bestätigungsmail mit weiteren Informationen.
                                </p>
                            </div>
                        </div>
                    </div>
