...
// Bookkeeping-Timestamps für mutable Rows. DB-DEFAULT bleibt erhalten (kein
// Schema-Recreate auf D1 nötig), Drizzle pflegt updatedAt zusätzlich via
// $onUpdateFn — Operations setzen es NICHT mehr explizit.
const timestamps = () => ({
